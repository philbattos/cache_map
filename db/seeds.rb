...
# Idaho Features
CSV.table('seed_data_files/ID_Features_Small_20130404.txt', col_sep: '|').each do |row|
...
# Montana Features
CSV.table('seed_data_files/MT_Features_Small_20130404.txt', col_sep: '|').each do |row|
...
# New Mexico Features
CSV.table('seed_data_files/NM_Features_Small_20130404.txt', col_sep: '|').each do |row|
...
# Utah Features
CSV.table('seed_data_files/UT_Features_Small_20130404.txt', col_sep: '|').each do |row|
...
# Wyoming Features
CSV.table('seed_data_files/WY_Features_Small_20130404.txt', col_sep: '|').each do |row|
